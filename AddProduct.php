...
if($c == 'men')
{
	mysql_query("INSERT INTO men(ProductType, Brand, Price, Imagepath, Description) VALUES('".$lab."', '".$b."', '".$p."', '".$np."', '".$desc."')", $db) or die("Failed to Insert Data in Database");
}

elseif($c == 'woman')
{
	mysql_query("INSERT INTO woman(ProductType, Brand, Price, Imagepath, Description) VALUES('".$lab."', '".$b."', '".$p."', '".$np."', '".$desc."')", $db) or die("Failed to Insert Data in Database");
}
else
{
