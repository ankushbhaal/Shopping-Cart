...
$r = mysql_query($query, $db) or die("There is no Data");
...
$r = mysql_query($query2, $db) or die("There is no Data");

}


while($row5 = mysql_fetch_row($r))
{
...
$result5 = mysql_query($query, $db) or die("There is no Data");
...
$result5 = mysql_query($query2, $db) or die("There is no Data");
