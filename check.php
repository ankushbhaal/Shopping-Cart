...
if($pm == 'Credit Card')
{
$r = mysql_query("INSERT INTO orders(FirstName, LastName, Email, ShippingAddress, Country, State, City, Zip_code, contactNo, ShippingMethod, PaymentMethod, TypeOfCreditcard, NameOnCC, CCNo, CVV, ExpirationDate, Email_id, Order_Ammount, temp) VALUES('".$fn."', '".$ln."', '".$e."', '".$add."', '".$cont."', '".$s."', '".$city."', '".$z."', '".$cn."', '".$sm."', '".$pm."', '".$ct."', '".$nc."', '".$ccno."', '".$cv."', '".$exd."', '".$em."', '".$tp2."', '".$odt."')") or die("Failed to Insert Data");
}
else
{

$r = mysql_query("INSERT INTO orders(FirstName, LastName, Email, ShippingAddress, Country, State, City, Zip_code, contactNo, ShippingMethod, PaymentMethod, Email_id, Order_Ammount, temp) VALUES('".$fn."', '".$ln."', '".$e."', '".$add."', '".$cont."', '".$s."', '".$city."', '".$z."', '".$cn."', '".$sm."', '".$pm."', '".$em."', '".$tp2."', '".$odt."')") or die("Failed to Insert Data");
...
foreach ($_SESSION["cart"] as $item)
{
	...
	mysql_query($que, $db) or die("Failed ");
	
}


$r2 = mysql_query("SELECT Order_id from orders WHERE temp = '$odt'");
...
mysql_query("update cart1 set Order_id = '$oid' where temp = '$odt'");

mysql_query("update cart1 set temp = '' where Order_id = '$oid'");
